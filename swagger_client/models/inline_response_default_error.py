...
class InlineResponseDefaultError(object):
    ...
    def __init__(self, code=None, message=None):  # noqa: E501
        """InlineResponseDefaultError - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def code(self):
        """Gets the code of this InlineResponseDefaultError.  # noqa: E501


        :return: The code of this InlineResponseDefaultError.  # noqa: E501
        :rtype: float
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this InlineResponseDefaultError.


        :param code: The code of this InlineResponseDefaultError.  # noqa: E501
        :type: float
        """
        if code is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InlineResponseDefaultError, dict):
